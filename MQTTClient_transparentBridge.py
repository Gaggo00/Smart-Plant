...
def on_message(_client, _userdata, message):
    ...
    new_payload = {
        ...
        'water_level':int(payload['Water_level'])
    }
...
# AWS IoT settings
AWS_IOT_ENDPOINT = "a2vd65fgsutnaw-ats.iot.eu-west-3.amazonaws.com"
AWS_IOT_PORT = 8883
...
AWS_IOT_PRIVATE_KEY = "./smartPlant.private.key"

# Set the relative path to the AWS IoT Certificate file
AWS_IOT_CERTIFICATE = "./smartPlant.cert.pem"
...
# TOPIC
MQTT_SUB_TOPIC = "smartPlant"
MQTT_PUB_TOPIC = "smartPlant/data"
